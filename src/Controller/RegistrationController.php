...
class RegistrationController extends AbstractController
{
     ...
     * @param WebAuthenticator $login
     * @return Response
     */
    public function __invoke(Request $request, UserPasswordEncoderInterface $userPasswordEncoder, GuardAuthenticatorHandler $guard, WebAuthenticator $login): Response
    {
        $user = new User();
